...
void report_speed(unsigned int left1_speed,unsigned int left2_speed,unsigned int right1_speed,unsigned int right2_speed)
{
    ...
    request_buffer[5]= left2_speed>>24;
    request_buffer[6]= left2_speed>>16;
    request_buffer[7]= left2_speed>>8;
    request_buffer[8]= left2_speed;

    request_buffer[9]= last_left2_is_forward;

    request_buffer[10]= right1_speed>>24;
    request_buffer[11]= right1_speed>>16;
    request_buffer[12]= right1_speed>>8;
    request_buffer[13]= right1_speed;

    request_buffer[14]= last_right1_is_forward;
    
    request_buffer[15]= right2_speed>>24;
    request_buffer[16]= right2_speed>>16;
    request_buffer[17]= right2_speed>>8;
    request_buffer[18]= right2_speed;
    request_buffer[19]= last_right2_is_forward;
