...
unsigned long left1_counter = 0;//左前测速计数器
unsigned long left2_counter = 0;//左后测速计数器

unsigned long right1_counter = 0;//右前测速计数器
unsigned long right2_counter = 0;//右后测速计数器

unsigned long left_enc = 0;
unsigned long right_enc = 0;
...
#define MESSAGE_TYPE_START_MOVE 0x01
#define MESSAGE_TYPE_STOP_MOVE 0x02
#define MESSAGE_TYPE_SET_SPEED 0x03
#define MESSAGE_TYPE_GET_SPEED 0x04
